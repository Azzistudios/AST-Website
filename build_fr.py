...
'index.html': dict(
    ...
    en_desc="Atelier Sans Titre is a Beirut scenography and event production studio producing special events, brand experiences and fashion shows for luxury clients in Beirut and across the Gulf.",
    fr_desc="Atelier Sans Titre est un studio de scénographie et de production événementielle à Beyrouth. Événements spéciaux, expériences de marque et défilés de mode pour des clients de luxe, à Beyrouth et dans le Golfe.",
...
'about.html': dict(
    ...
    en_desc="A scenography and event production studio built on one conviction: that space is the most powerful medium in any event. Based in Beirut, working across the Gulf.",
    fr_desc="Un studio de scénographie et de production événementielle fondé sur une conviction : l'espace est le médium le plus puissant de tout événement. Basé à Beyrouth, actif dans tout le Golfe.",
...
'disciplines.html': dict(
    ...
    fr_map={**NAV, **FOOT, **PROJ, 'disc-page-title':'Disciplines',
        ...
        'route-f-t':'Défilés','route-f-d':"Offrir à une collection la salle qu'elle mérite.",'filter-all':'Tous','filter-fashion':'Défilés de mode','filter-brand':'Expériences de marque','filter-events':'Événements spéciaux'},
    literals=[], group_desc=None,
...
'contact.html': dict(
    ...
    fr_desc="Contactez Atelier Sans Titre. Nous produisons des événements spéciaux, des expériences de marque et des défilés de mode depuis notre studio à Beyrouth, pour des clients du Golfe.",
