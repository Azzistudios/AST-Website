...
'about.html': dict(
    ...
    fr_map={**NAV, **FOOT,
        ...
        "studio-sectors":"Le travail s'inscrit dans la mode, la joaillerie, la beauté, les spiritueux, l'automobile et la culture.",
        ...
        "credits":"Photographies © leurs auteurs respectifs. Images de projets publiées avec l'accord des clients.",
        'page-title':'À propos',
        ...
        'studio-p1':'Sans Titre est un studio de scénographie et de production créative basé à Beyrouth, fondé en 2026 par Marc Azzi, architecte et scénographe. Nous concevons et produisons des <a href="disciplines.html">événements spéciaux</a>, des <a href="disciplines.html">expériences de marque</a> et des <a href="disciplines.html">défilés de mode</a> pour des clients de luxe à travers la région et au-delà.',
